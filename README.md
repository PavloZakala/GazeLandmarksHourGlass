...
* 8 точок, що описують краї зіниці (cyan точки)
* 7 точок, що описують краї вій (blue точки)
* 1 точка, що описує центр зіниця (pink точки)
* 1 точка, що описує центр очного яблука (green точка)
...
Тренування тривало 5 епох, кожна з яких пройшла 1000 batch по 16 картинок в одному (batch size). 
